" File: colors/robcolors.vim
" Description: Color script, probably abandonware.
" Maintainer: Nobody, it's probably abandonware!
" Inspiration: http://robert.nowotniak.com/pl/other/vim/
